<?php
    ...
    if($_SERVER['REQUEST_METHOD']==='POST'){
        ...
        if(empty($errores)) {
            ...
            $query ="INSERT INTO propiedades (titulo, precio, imagen, descripcion, habitaciones, bano, estacionamiento, creado, vendedores_id) VALUES ('$titulo', $precio, '$nombreImagen', '$descripcion', $habitaciones, $banos, $estacionamiento, '$creado', $vendedorId)";
